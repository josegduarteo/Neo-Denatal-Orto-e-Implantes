...
const Gallery = () => {
  ...
  const images = [
    ...
    {
      src: "/lovable-uploads/6cadc639-7a66-489b-88b4-98d0a4d0a73c.png",
      alt: "Consultório moderno com equipamentos avançados",
      title: "Consultório Moderno"
    },
    {
      src: "/lovable-uploads/2db1336f-b24d-4599-8b33-1e081ab281ae.png",
      alt: "Sala de procedimentos odontológicos",
